...
function mainController($http, DailyList) {
    ...
    ctrl.addFood = function addFood() {
      ...
      console.log(ctrl.currentNutrChoice);
      ctrl.totalCal = ctrl.totalCal + ctrl.currentNutrChoice.nf_calories;
      ctrl.vitC = ctrl.vitC + ctrl.currentNutrChoice.nf_vitamin_c_dv;
      ctrl.currentNutrChoice = null;
      updateSuggestion();
    };
