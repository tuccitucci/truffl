...
function makeASuggestion(list) {
  ...
  var nutrientSuggestions = {
    ...
    'Iron, Fe': 'Try eating more red meats or mussels.',
    'Magnesium, Mg': 'Eating dark leafy greens would help',
    'Phosphorus, P': 'Poultry and dairy products is what I suggest',
    'Potassium, K': 'Add some Bananas to your breakfast routine, or throw one in as a midday snack.',
    'Sodium, Na': 'Salted nuts might be the answer',
    'Zinc, Zn': 'Try some spinach today Popeye! Beef is also a great food for upping your Zinc levels because ounce for ounce it has more zinc than many other foods',
    ...
    'Selenium, Se': 'Brazil nuts, Yellowfin tuna and Halibut are all high in Selenium',

    'Vitamin A, IU': 'Vitamin A is a fat soluble vitamin, and therefore, needs to be consumed with fat in order to have optimal absorption. High vitamin A foods include sweet potatoes, carrots, dark leafy greens, winter squashes, lettuce, dried apricots, cantaloupe, bell peppers, fish, liver, and tropical fruits',
    ...
    'Vitamin B-12': 'Foods high in Vitamin B12 include shellfish, liver, fish, crab, fortified soy products (tofu, soymilk), fortified cereals, red meat, low fat dairy, cheese, and eggs',
    'Vitamin B-6': 'Bran and Pistachios are great options here.',
    'Niacin': 'Turkey and Chicken breast might be the solution.',
    'Folate, total': 'Dark leafy greens and asparagus are excellent sources of Folate.',
    'Vitamin C, total ascorbic acid': 'Grab an orange or eat some red peppers today!',
    'Vitamin E (alpha-tocopherol)': 'Almonds and Swiss Chard are a possible solution.',
    'Vitamin D': 'Might be time to eat some tuna or salmon.',
  };
